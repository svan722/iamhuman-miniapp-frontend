...
export default function OtherTgVerifyFailed() {
    ...
    <div className="pt-[10px] " style={{ fontFamily: "Inter" }}>
      <div className="px-8">
        ...
        <div className="text-center mt-[10px]">
          ...
          <p className="font-[400] text-[16px] leading-[19.36px] pt-3 px-[10px]">
          Your ImHuman account is already linked to another Telegram user. Please try to link it with an unlinked ImHuman account. Please generate a new code and try again.
          </p>
        </div>
