        ...
        <div className="-z-20">
          <div className="px-4 pb-[115px] bg-white">
            <div className="rounded-[8px] border border-[#D3D3D3] p-[16px]">
              <h1 className="font-[600] text-[20px] leading-[24.2px] mb-[20px]">Pending profile edits</h1>
              <div className="text-[14px] font-[400] leading-[16.94px] my-[10px]">Your edits will be saved once you have verified your Human Likeness in the ImHuman App. </div>
              ...
              <div className="mt-[10px]">
                <Button background={true} disabled={false} text="View my verification" onClick={() => {navigate("/profileverify")}} />
              </div>
            </div>
