  ...
  return (
    <div className={`w-full p-[30px] absolute bottom-[-40%] block rounded-lg bg-white border-[#D3D3D3] border modal-anim-slideIn`} style={{fontFamily: "Inter"}}>
      <div className="flex flex-col items-center p-[10px]">
        ...
        <div className="text-[16px] font-[400] leading-[22px] text-center">You can link up to 5 ImHuman accounts each month. At the start of every month, your limit will reset.</div>
      </div>
